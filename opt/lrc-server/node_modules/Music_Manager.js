...
exports.driver = {
    ...
    parse_infos: function(stdout) {
        info = stdout.split(";");
        return {artist: escape(info[0]), album: escape(info[1]), title: escape(info[2]), elapsed: info[3], duration: info[4], state: "unknown"};
    },
...
// moc
// Uncomment this part and comment other drivers to activate it
/*
exports.driver = {
    name: "moc",
